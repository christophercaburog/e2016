  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="3">
    ...
    <tr id="disRegion">
      ...
      <td width="62%"><select name="region_post_id" id="region_post_id" style=" width: 114px;">
        <?php echo html_options_2d($oRecRegionPost,'rgn_id','region_name',$oData['political_candidates_district'],false);?>
      </select></td>
    </tr>
     <tr id="disProvince">
      <td width="12%" scope="row">&nbsp;</td>
    ...
    <tr id="disDistrict">
     ...
     <tr id="disMunicipality">
      ...
      <td width="62%">
          ...
          <input type="text" name="municipality_name" id="municipality_name" value="">
