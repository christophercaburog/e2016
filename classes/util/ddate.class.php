...
class dDate {
	...
	static protected $time_unit_format = 22; //Minutes
...
//			Debug::text('Parsed Date: '. dDate::getDate('DATE+TIME', $epoch) , __FILE__, __LINE__, __METHOD__, 10);
     ...
     *
     * Format:
     * <ul><li>date</li><li>time</li><li>date+time</li><li>epoch</li></ul>
     *
     * Custom Format: will parse the date given to a date format specified 
     *
     * @param string $format 
     * @param int $epoch
     ...
     * @return string
     */
	public static function getDate($format = NULL, $epoch = NULL, $customformat = null) {
